...
MolClaw gives you the core functionality without that mess.
...
- Custom `molclaw` MCP server (inside container) provides scheduling tools
...
**MolClaw** - A reference to Clawdbot (now OpenClaw).
